...
COPY --chown=$MAMBA_USER:$MAMBA_USER agent.py app_settings.py news_sources.py news_cache.py news_classify.py news_embed.py news_keyness.py news_ingest.py news_push.py bot.py admin_bot.py combined_bot.py telemetry.py ptb_error_handler.py guardrails.py interest_finder.py subscriber_ops.py category_ops.py push_outcome_ops.py api_budget_ops.py interest_cache_ops.py source_state_ops.py test_api.py telegram_html.py message_archive.py settings.oracle.yml settings.int.yml docker-entrypoint.sh ./
